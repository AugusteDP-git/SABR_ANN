...
ckpt = join(OUT_DIR, "w500_short", "best_w500.pt")
model = GlobalSmileNetVector(in_dim=15, hidden=(500,), out_dim=10).to(DEVICE)
...
plot_3d_smile_beta_surface(
    ...
    scalers=scalers,
    model=model,
    out_png=join(OUT_DIR, "fig3_beta_surface_500_short.png"),
    device=DEVICE,
    beta_min=0.0,
    beta_max=1.0,
    n_beta=21,
